...
async def test_verify_token_exp(jwt_service, jwt_client):
    ...
    with freeze_time("2023-03-25 12:30:00"):
        data = await jwt_client.verify_token(response['body'])
